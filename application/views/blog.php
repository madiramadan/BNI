        ...
        <section class="you-can-help section-bottom" style="padding-top:20px;">
        	<div class="container">
        		<div class="row desktop">
        			<?php
        			if($id_blog_cat) $q = GetAll("blog", array("id_blog_cat"=> "where/".$id_blog_cat, "is_publish"=> "where/1", "is_delete"=> "where/0", "is_featured"=> "where/0", "publish_date"=> "order/desc", "limit"=> "0/2"));
        			else $q = GetAll("blog", array("is_publish"=> "where/1", "is_delete"=> "where/0", "is_featured"=> "where/0", "publish_date"=> "order/desc", "limit"=> "0/2"));
	            foreach($q->result_array() as $r) {
            ...
            <div class="row mobile">
        			<?php
        			if($id_blog_cat) $q = GetAll("blog", array("id_blog_cat"=> "where/".$id_blog_cat, "is_publish"=> "where/1", "is_delete"=> "where/0", "is_featured"=> "where/0", "publish_date"=> "order/desc", "limit"=> "0/1"));
        			else $q = GetAll("blog", array("is_publish"=> "where/1", "is_delete"=> "where/0", "is_featured"=> "where/0", "publish_date"=> "order/desc", "limit"=> "0/1"));
	            foreach($q->result_array() as $r) {
	            	if(file_exists("./uploads/articles/".$r['image'])) $img=$img2;
	            	else $img=$imgz;
	            	?>
	            ...
	            <div class="row">
        			<?php
        			if($id_blog_cat) $q = GetAll("blog", array("id_blog_cat"=> "where/".$id_blog_cat, "is_publish"=> "where/1", "is_delete"=> "where/0", "is_featured >"=> "where/0", "is_featured"=> "order/asc", "limit"=> "0/4"));
        			else $q = GetAll("blog", array("is_publish"=> "where/1", "is_delete"=> "where/0", "is_featured >"=> "where/0", "is_featured"=> "order/asc", "limit"=> "0/4"));
					//lastq();
	            foreach($q->result_array() as $r) {
	            	if(file_exists("./uploads/articles/".$r['image'])) $img=$img2;
	            	else $img=$imgz;
            	...
            	<?php
        			...
        			if($id_blog_cat) $q = GetAll("blog", array("id_blog_cat"=> "where/".$id_blog_cat, "is_publish"=> "where/1", "is_delete"=> "where/0", "publish_date"=> "order/desc", "limit"=> "2/5"));
        			else $q = GetAll("blog", array("is_publish"=> "where/1", "is_delete"=> "where/0","publish_date"=> "order/desc", "limit"=> "2/5"));
	            foreach($q->result_array() as $r) {?>
