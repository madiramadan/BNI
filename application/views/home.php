...
<section class="main-slider main-slider-three" id="sectionhome" style="margin-top:5%;width:100vw;aspect-ratio:16/7;max-width:1700px;margin: 0 auto; padding-top:70px;">
    ...
    "autoplay": {
        ...
        <section class="main-slider you-can-help" style="padding-top:80px;" id="section3">
        	<div class="bellahome" style="background-image:url('<?php echo base_url();?>uploads/Bella-Homepage-Desktop-3juli2024.jpg');background-repeat:no-repeat;">
        		<div class="swiper-container thm-swiper__slider" data-swiper-options='{"slidesPerView": 1, "loop": true,
    "effect": "slide",
    "pagination": {
