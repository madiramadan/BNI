...
/* media screen for mobile | madi bau*/
@media screen and (max-width: 600px) {
    #lenna-webchat > div > div:nth-child(1) > img.sc-launcher.open-image.close-color.custom-open-icon {  display: block;
        width: 128px;
        right: 90px !important;
        bottom: 17px !important;
    }
    
    #lenna-webchat-bubble-launcher > img {
        bottom: 17px !important;
        position: fixed;
        right: 17px !important;
    }

    .main-slider-three .swiper-slide__inner-home {
        left: 0 !important;
        height: 100% !important;
        width: 100% !important;
    }

    body > div.page-wrapper > section.main-slider.main-slider-three > div > div.swiper-wrapper > div.swiper-slide.swiper-slide-active > div.container > div > div {
        margin: 0 !important;
        padding: 0 !important;
    ...
    body > div.page-wrapper > section.main-slider.main-slider-three > div > div.swiper-wrapper > div.swiper-slide.swiper-slide-active > div.container > div > div > div > a {
        position: absolute;
        width: max-content;
        bottom: 70px;
        left: 50%;
...
<link rel="stylesheet" href="<?php echo base_url();?>assets/css/custom_mobile.css">
	                                ...
	                                <div class="row">
	                                    <div class="col-xl-12 text-left mb-slider">
	                                        ...
	                                        <!-- <a style="margin-top:86%; margin-left:50% !important; width:100% !important; " href="<?php echo $r['link']?>" class="<?php echo is_numeric(substr($r['title'], 0, 1)) == true ? 'thm-btn btn-selengkapnya'.substr($r['title'], 0, 1) .$bil : 'thm-btn' .$bil ?>"> <?php echo $r['contents'.getLang()];?></a>
	                                         -->
											<a href="<?php echo $r['link']?>" class="<?php echo is_numeric(substr($r['title'], 0, 1)) == true ? 'thm-btn btn-selengkapnya'.substr($r['title'], 0, 1) .$bil : 'thm-btn' .$bil ?>"> <?php echo $r['contents'.getLang()];?></a>
	                                        <?php } 
	                                        ?>
	                                    </div>
	                                </div>
    ...
    "autoplay": {
        ...
        <section class="main-slider you-can-help" style="padding-top:80px;" id="section3">
        	<div class="bellahome" style="background-image:url('<?php echo base_url();?>uploads/Bella-Homepage-Mobile-3juli2024.jpg');background-repeat:no-repeat;background-size:cover;background-color:#6fc1d9;">
        		<div class="swiper-container thm-swiper__slider" data-swiper-options='{"slidesPerView": 1, "loop": true,
    "effect": "slide",
    "pagination": {
                    ...
                    <div class="col-xl-12 col-lg-12">
                        <div class="you-can-help__left">
                            ...
                            <div class="tabz_new marbot25">
							        				<!-- <div class="col-md-2 col-xs-2 nop-all">
							        					<a style="display:none;" class="linklayanan wow zoomIn" data-wow-delay="100ms" rel="1"><?php echo $bahasa[20];?></a>
							        				</div> -->
							        				<div class="col-md-6 col-xs-6 nop-all">
							        					<a class="linklayanan aktif wow zoomIn" data-wow-delay="300ms" rel="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $bahasa[21];?>
														&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
							        				</div>
							        				<div class="col-md-6 col-xs-6 nop-all">
							            	...
							            	<div class="row">
								                <div class="col-xl-12">
								                	<div class="row">
								                		...
								                		$q = GetAll("blog",array("is_publish"=> "where/1", "is_delete"=> "where/0", "publish_date"=> "order/desc", "limit"=> "0/1"));
								                		foreach($q->result_array() as $k=> $r) {
				                                    ...
				                                    <p class="ket"><?php echo $r['headline'.getLang()];?></p>
									                  ...
									                  <?php
								                		$q = GetAll("blog",array("is_publish"=> "where/1", "is_delete"=> "where/0", "publish_date"=> "order/desc", "limit"=> "1/2"));
								                		foreach($q->result_array() as $k=> $r) {
								                			if(file_exists("./uploads/articles/".$r['image'])) $img=$img2;
								                			else $img=$imgz;
								                			?>
								                    ...
								                    <div class="col-md-3 nop_l col-xs-6">
									                  <?php
								                		$q = GetAll("blog",array("is_publish"=> "where/1", "is_delete"=> "where/0", "publish_date"=> "order/desc", "limit"=> "3/2"));
								                		foreach($q->result_array() as $k=> $r) {
								                			if(file_exists("./uploads/articles/".$r['image'])) $img=$img2;
								                			else $img=$imgz;
								                			?>
