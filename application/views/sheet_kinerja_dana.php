		                        			...
		                        			<div class="row perlindungz perlindung<?php echo $kk;?>" style="padding:15px; <?php echo $kk==0 ? "" : "display:none;";?>">
												...
												<div style="overflow-x:auto;">  
													...
													<table id="table-data" class="table table-bordered table-hover table-striped" style="font-size:80%;">
															<tr>
																<th class="sticky-left" style="text-align:left;vertical-center:left;border-left:hidden;border-right:hidden;"><?php echo getLang() ? "Fund Name" : "Produk"?></th>
													...
													{?>	
														<tr>
															<th class="sticky-left" style="border-left:hidden;border-right:hidden;"><?php echo $rrr['Product']?></th>
